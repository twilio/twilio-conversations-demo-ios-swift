...
fileprivate class ReactionModelTest: XCTestCase {
    ...
    func testRecactionCountAfterAddingHeart() {
        ...
        model.tooggleReaction(recation: ReactionType.heart, forParticipant: "test-participant-a")
    ...
    func testRecactionCountFor2ParticipantReaction() {
        var model = MessageReactionsModel()
        model.tooggleReaction(recation: ReactionType.heart, forParticipant: "test-participant-a")
        model.tooggleReaction(recation: ReactionType.heart, forParticipant: "test-participant-b")
